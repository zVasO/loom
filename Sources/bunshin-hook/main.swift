...
// bunshin-hook — le helper appelé par les hooks des agents (ADR-0005).
...
//
// Usage : bunshin-hook --socket <chemin> --token <jeton>

func fail(_ message: String) -> Never {
    FileHandle.standardError.write(Data("bunshin-hook: \(message)\n".utf8))
    exit(1)
}
