...
struct GitHubRepoNameTests {
    ...
    func remoteSpellings() {
        for remote in ["git@github.com:acme/core.git", "git@github.com:acme/core",
            ...
            #expect(GitHubRepoName.parse(remoteURL: remote) == "acme/core", Comment(rawValue: remote))
        }
    }
    ...
    func otherHosts() {
        for remote in ["git@gitlab.com:acme/core.git", "https://github.acme.com/acme/core",
            ...
            #expect(GitHubRepoName.parse(remoteURL: remote) == nil, Comment(rawValue: remote))
        }
    }
...
struct PRReferenceTests {
    ...
    func urls() {
        for text in ["https://github.com/acme/core/pull/42",
            ...
            #expect(PRReference.parse(text) == PRReference(repo: "acme/core", number: 42), Comment(rawValue: text))
        }
    }
    ...
    func notAReference() {
        for text in ["https://github.com/acme/core", "https://github.com/acme/core/issues/3",
            ...
            #expect(PRReference.parse(text) == nil, Comment(rawValue: text))
        }
    }
}
